...
// Version
#define AIRMOTIONLIB_VERSION_MAJOR  4
#define AIRMOTIONLIB_VERSION_MINOR  1
...
typedef struct
{
    ...
    int8_t                          GyroTremorCanceling;    //!< Gyroscope tremor canceling setting (from -1 to 7, use -1 to disable Tremor Canceling)
...
*   lInitParameters.GyroTremorCanceling     = 7;
*
...
* @return None
*/
void AIR_MOTION_ResetSwipeRecognition(void);
